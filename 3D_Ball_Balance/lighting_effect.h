bool light_1 = false, light_2 = false, light_3 = false, ex_light = true, light_4 = false, fan_on = false;
float ar = 0.8, ag = 0.8, ab = 0.8, dr = 1, dg = 1, db = 1, sr = 1, sg = 1, sb = 1;
...
//    GLfloat light_position[] = { 0.0, 20.0, 0.0, 1.0 };
    ...
    GLfloat light_ambient[]  = {ar,ag,ab, 1.0};
...
void spot_light_effect(float x, float y, float z, float cut_off = 25.0, float R=1, float G=1, float B=1)
{
    ...
    GLfloat light_direction[] = {0,-1,1,1};
